----------------------------------------------
-- OPTIMIZED AND FOR ESX LEGACY 1.9
-- LIAM16361#0001 IF YOU NEED HELP!!!
----------------------------------------------
...
function discordlog(desc)
    ...
    PerformHttpRequest(cfg?.webhook, function(err, text, headers) end, 'POST', json.encode({
        username = 'Liam16361#0001', 
        avatar_url = 'https://cdn.discordapp.com/attachments/1062177995596505088/1064330092374925362/liam.png', 
